                    ...
                    <div class="card col-md-5 mx-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="category" id="category-feild" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="" class="form-control" placeholder="Type name"
                                    value="{{ old('name') }}">
                                @error('name')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tags" id="" class="form-control" placeholder="Type tags"
                                    value="{{ old('tags') }}">
                                @error('tags')
                                <div>{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" name="v_link" id="" class="form-control" placeholder="link"
                                    value="{{ old('v_link') }}">
                                @error('v_link')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="theme-preview">Preview <kbd>.png</kbd></label> <span
                                    class="text-danger">*</span>
                                <div class="custom-file">
                                    <input class="custom-file-input" type="file" name="theme_preview" id="theme-preview"
                                        required="">
