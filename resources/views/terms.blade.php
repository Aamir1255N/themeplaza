...
<div class="container-fluid mt-4">
	...
	<div class="container">
		...
		<div class="card mb-3">
			<div class="card-body pb-0">
				<h4>COPYRIGHT</h4>
				<p>If a file uploaded falls under a current, legal copyright. The owner of those copyrights may submit
					proof of
					their ownership to us in order to request a takedown of their property to abuse@themeplaza.eu.</p>
				<p>We reserve the right to deliberate on takedown matters.</p>
				<p>By uploading to this service you agree that the uploaded content is purely fan made and not created
					by Nintendo or their partners.</p>
			</div>
		</div>
		<div class="card mb-3">
			<div class="card-body pb-0">
				...
				<p>If you encounter any bugs, exploits or any method that can be used to damage the service or servers,
					please make
					sure you report them as soon as possible via the <a href="contact.html">Contact Form</a>.</p>
			</div>
		</div>
		<div class="card">
			<div class="card-body pb-0">
